...
// o programa executa.// Menu// 1 - Cadastrar usuário (só o nome completo)// - gerar o email //
- verificar se este email já foi gerado (na lista)// - caso não exista, colocar na lista e persistir 
no arquivo: nome completo;email// 2 - Listar os usuários (nome completo e email)// - mostrar ordenado
(pode)// 3 - Sair // Opção: //StreamReader, StreamWriter, List, Usuario
